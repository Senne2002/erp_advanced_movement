		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Movement",
									"targetURL": "#movementerpadvancedmovement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"movementerpadvancedmovement-display": {
								"semanticObject": "movementerpadvancedmovement",
								"action": "display",
								"description": "A Fiori application for movements.",
								"title": "Movement",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=movement.erpadvancedmovement",
									"url": sap.ui.require.toUrl("movement/erpadvancedmovement")
								}
							}
						}
					}
